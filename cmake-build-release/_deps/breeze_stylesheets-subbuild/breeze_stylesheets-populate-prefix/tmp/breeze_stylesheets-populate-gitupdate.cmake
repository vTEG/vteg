...
execute_process(
  COMMAND "/opt/homebrew/bin/git" show-ref "origin/master"
  WORKING_DIRECTORY "/Users/tommetz/CLionProjects/vteg/cmake-build-release/_deps/breeze_stylesheets-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/tommetz/CLionProjects/vteg/cmake-build-release/_deps/breeze_stylesheets-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/tommetz/CLionProjects/vteg/cmake-build-release/_deps/breeze_stylesheets-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
